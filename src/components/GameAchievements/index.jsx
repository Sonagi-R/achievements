...
export default function GameAchievement() {
  ...
  async function syncAchievements() {
    ...
    achievementsData.playerstats.achievements.map(async (achievement, index) => {
      if (achievement.apiname == achievementInfoData.game.availableGameStats.achievements[index].name && achievement.achieved == 1) {
      ...
      <div>
        {achievementList.map((achievement) => (
          <div className="achievement">
            <img className="d-inline-block" src={achievement.icon} alt="achievement icon" />
            <article>
      ...
      <div className="d-flex justify-content-center">
        <div className="game-container position-relative z-1 d-flex flex-wrap">
          <div className="game-content">
            <img className="game-image" src={localStorage.background_image} alt="picture of the witcher 3 game" />
            <h2 className="game-title mb-5">{localStorage.game_name}</h2>
            <div className="game-description">
              <p className="description-text"  dangerouslySetInnerHTML={{__html: localStorage.game_description}}></p>
            </div>
          </div>
          ...
          <div className="achievement-container">
            ...
            <div className="achievement-overflow-scroller">
              {loading ? (
                ...
                <h2>
                  <em>Achievements have not been Synced...</em>
                </h2>
              )}
            </div>
          </div>
